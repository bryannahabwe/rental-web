...
A modern, responsive web application for managing rental properties, tenants, agreements, and payments. Built with React
19 and Vite, this frontend provides a comprehensive dashboard and management tools for property owners and managers.
...
* **Responsive Design:** Fully optimized for both desktop and mobile users with a persistent sidebar and mobile bottom
  navigation.
